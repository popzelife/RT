...
void raytracer_highres(t_tharg *a);
void raytracer_lowres(t_tharg *a);
...
t_surface *lst_new_image(t_surface **surface, t_surfparam param, SDL_Renderer
                                                                     *render,
                         SDL_Texture *(f)(SDL_Renderer *, const char *, int *, int *));
t_string *lst_new_string(t_string **string, t_strparam param, SDL_Renderer
                                                                  *render,
                         t_text(f)(char *, t_font, int[2], SDL_Renderer *));
...
void lst_set_surface(t_surface **surface, t_surfparam param, SDL_Renderer
                                                                 *render,
                     void(f)(SDL_Surface *, const SDL_Rect *, const int, void *));
