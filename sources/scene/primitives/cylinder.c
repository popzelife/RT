                                  ...
                                  t_discriminant *d)
{
  ...
  d->a = v3_dot_double_(ray.dir, ray.dir) - v3_dot_double_(ray.dir, c->vertex) * v3_dot_double_(ray.dir, c->vertex);
  d->b = 2 * (v3_dot_double_(ray.dir, d->oc) - v3_dot_double_(ray.dir, c->vertex) * v3_dot_double_(d->oc, c->vertex));
  d->c = v3_dot_double_(d->oc, d->oc) - v3_dot_double_(d->oc, c->vertex) * v3_dot_double_(d->oc, c->vertex) - c->radius2;
                  ...
                  t_hit *param)
{
  ...
  if (d.discriminant >= 0)
  {
    ...
    {
      d.m = v3_dot_double_(ray.dir, v3_scale_vec_(c->vertex, d.sol)) + v3_dot_double_(d.oc, c->vertex);
