...
static void text_add_prim(t_rt *rt)
{
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
...
static void list_object2(t_rt *rt)
{
  ...
  lst_set_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_color, rt->panel.word1, i, 7),
      rt->esdl->eng.render,
...
void draw_text_list_object(t_rt *rt)
{
  ...
  lst_set_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_pos, rt->panel.word1, i, 3),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  ...
  lst_set_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_mat, rt->panel.word1, i, 6),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  list_object2(rt);
  free(i);
...
void draw_text_surface(t_rt *rt)
{
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
          "Object Setting:", rt->panel.title1, i, 0),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
          "Render Tools:", rt->panel.title1, i, 0),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  free(i);
}
...
void list_object_bis(t_rt *rt)
{
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_mat, rt->panel.word1, i, 0),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_color, rt->panel.word1, i, 0),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  free(i);
}
...
void text_list_object(t_rt *rt)
{
  ...
  rt->panel.lst_string = lst_new_string(
      &(rt->panel.lst_string),
      strparam(
          rt->panel.viewparam.str_pos, rt->panel.word1, i, 0),
      rt->esdl->eng.render,
      esdl_render_blendedtext);
  settab2(i, WIN_RX - MENU_RX + 5, 289 + 60 + TILE_RY);
  rt->panel.lst_string = lst_new_string(
